   ...
   export default function AddHospitalPage() {
     ...
     const handleSubmit = async (e: React.FormEvent) => {
       ...
       if (!formData.name || !formData.address || !formData.phone || !formData.latitude || !formData.longitude) {
         setError("Harap isi semua kolom wajib (Nama, Alamat, Telepon, Latitude, Longitude)");
         return;
       }
     ...
     return (
       <AdminLayout>
         <div className="max-w-3xl mx-auto mt-10 p-8 bg-white rounded-xl shadow-lg">
           <h1 className="text-3xl font-bold text-blue-800 mb-8 text-center">Tambah Rumah Sakit</h1>
           {error && (
           ...
           <form onSubmit={handleSubmit} className="space-y-6">
             <div>
               <label className="block text-sm font-semibold text-gray-700 mb-1">Nama RS *</label>
               <input
                 name="name"
                 value={formData.name}
             ...
             <div>
               <label className="block text-sm font-semibold text-gray-700 mb-1">Layanan (pisahkan dengan koma)</label>
               <input
                 name="services"
